...
## Before First Real Repo

### Q1: Supplement Directory Structure
What does a supplement look like in AsciiDoc? Specifically:
- Is it one big `.adoc` file or split by volume/section?
- Does it follow the IHE volume structure (Vol 1: Integration Profiles, Vol 2: Transactions, Vol 3: Content)?
- Is there a frontmatter/header convention (supplement title, status, revision, date)?
